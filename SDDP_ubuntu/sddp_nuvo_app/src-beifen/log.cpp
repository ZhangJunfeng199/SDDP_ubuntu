...
void Log::init()
{
	...
	sprintf(file_path[LT_MESSAGE], "data/%s-log.dat", file_prefix);
	sprintf(file_path[LT_FRAME_ALL], "data/%s-frame-all.dat", file_prefix);
	sprintf(file_path[LT_FRAME_CAN0_RECV], "data/%s-frame-can0-recv.dat", file_prefix);
	sprintf(file_path[LT_FRAME_CAN0_SEND], "data/%s-frame-can0-send.dat", file_prefix);
	sprintf(file_path[LT_FRAME_CAN1_RECV], "data/%s-frame-can1-recv.dat", file_prefix);
	sprintf(file_path[LT_FRAME_CAN1_SEND], "data/%s-frame-can1-send.dat", file_prefix);
