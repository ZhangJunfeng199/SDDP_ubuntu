...
int main(int argc, char** argv)
{
	...
	mot_ctrl = new MotCtrl();
	if (mot_ctrl == NULL) {
		perror("failed to create mot_ctrl!\n");
		exit(1);
	}
	...
	int ret = mot_ctrl->uart_write(w_buf,w_len);
    if(ret == -1) {
...
//	Log::instance()->enable(Log::LF_MSG, false);
//	Log::instance()->enable(Log::LF_FRAME_ALL | Log::LF_FRAME_CAN0_RECV | Log::LF_FRAME_CAN0_SEND |	\
//							Log::LF_FRAME_CAN1_RECV | Log::LF_FRAME_CAN1_SEND, false);
